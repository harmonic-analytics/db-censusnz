...
#'
#' @format A data frame with 2939216 rows and 5 variables:
#' \describe{
...
#' at the Ward level.
#'
#' @format A data frame with 320784 rows and 5 variables:
#' \describe{
...
#'
#' @format A data frame with 28688 rows and 5 variables:
#' \describe{
...
#' Data on Individuals from NZ Census 2018 at Territorial AuthorityLevel
#'
#' A dataset containing the responses on individuals from the 2018 NZ Census
#' at the Territorial Authority level.
#'
#' @format A data frame with 89976 rows and 5 variables:
#' \describe{
...
#'
#' @format A data frame with 23472 rows and 5 variables:
#' \describe{
