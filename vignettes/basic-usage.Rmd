...
To get started working with __censusnz__, instantiate a `DataModel` object:
...
Querying the Census data requires you to set three parameters:

1. [`geography`](#geography);
2. [`variables`](#variables); and
3. `year` (choose from 2006, 2013 or 2018).
...
require a geography that is missing from the table above, please file an issue
...
all regions combined. We do that by using
